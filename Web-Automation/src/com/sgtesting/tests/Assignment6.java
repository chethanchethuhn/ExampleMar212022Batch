...
public class Assignment6 {
	...
	private static void modifyproject()
	{
		try {
			...
			Thread.sleep(2000);
			//obrowser.findElement(By.xpath("//div[text()='precissssion life science labs']")).click();
			//Thread.sleep(3000);
			obrowser.findElement(By.xpath("//*[@id='taskListBlock']/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea")).sendKeys("ABC");
			Thread.sleep(3000);
		} catch (Exception e) {
			e.printStackTrace();
		}
